...
var PredictiveSearch = /*#__PURE__*/function (_SearchForm) {
  ...
  return _createClass(PredictiveSearch, [{
    ...
    value: function getResultsMaxHeight() {
      ...
      this.resultsMaxHeight = window.innerHeight - ((_document$querySelect = document.querySelector('.section-header')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.getBoundingClientRect().bottom);
